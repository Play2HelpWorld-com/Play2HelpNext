...
const BlogData: Charity[] = [
  {
    ...
    metadata:
      "Support clean water initiatives worldwide while gaming. Every play contributes to bringing safe water to families in need, promoting health and happiness globally.",
  },
  {
    ...
    metadata:
      "Protect wildlife and natural habitats through gameplay. Join our mission to maintain ecological sustainability while experiencing the joy of gaming for good.",
  },
  {
    ...
    metadata: "Support healthcare for communities in crisis. Your gameplay helps deliver proven health benefits to those who need it most.",
  },
  {
    ...
    metadata:
      "Fight poverty and inequality through gaming. Help families worldwide achieve economic sustainability and access to education, health, and opportunity.",
  },
  {
    ...
    metadata: "Empower children worldwide through education and health programs. Every game session contributes to building brighter futures.",
  },
  {
    ...
    metadata: "Advance medical breakthroughs while you play. Support health research that saves lives and brings hope to families.",
  },
  {
    ...
    metadata: "Enable microloans for entrepreneurs in developing countries. Your gaming helps promote economic sustainability and financial independence.",
  },
  {
    ...
    metadata: "Support research and care for those affected by dementia. Gaming for health benefits that matter to families everywhere.",
  },
  {
    ...
    metadata: "Aid disaster relief and emergency response worldwide. Your gameplay delivers real-world health and humanitarian benefits.",
  },
];
