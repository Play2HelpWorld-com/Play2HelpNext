...
export const fetchLoggedInUser = createAsyncThunk('auth/fetchLoggedInUser', async (_, { rejectWithValue }) => {
  ...
  try {
    ...
    console.log('Error while getting loggedIN user at fetchLoggedInUser in authSlice.ts file', error);
  }
});
